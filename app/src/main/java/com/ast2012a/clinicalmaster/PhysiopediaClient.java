 ...
 * في ويكيبيديا (تشابه تقني فقط في طريقة الاستضافة، مش علاقة استخدام).
 * المرجع الأساسي (لا الوحيد - راجع WikipediaClient كمصدر ثانٍ مستقل
 * يُستدعى بجانبه من AiOrchestrator.v7) للتأريض المعرفي العام في التطبيق،
 * لأنه محتوى متخصص مراجَع من أخصائيي علاج طبيعي فعليًا - يُفضَّل عند أي
 * تعارض في تفصيل علاجي متخصص لأنه الأدق سريريًا في مجاله بالذات.
 *
 ...
 * غيّر بنيته، يرجع null بأمان والتطبيق يكمّل بمعرفة النموذج العامة فقط
 * (موضّح صراحة في شارة المصدر) - بدون أي كراش أو توقف.
 */
